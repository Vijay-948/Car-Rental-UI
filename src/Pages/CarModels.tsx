                ...
                <div className="models-div__box">
                    <div className="models-div__box__img">
                        ...
                        <div className="models-div__box__descr">
                            ...
                            <div className="models-div__descr__name-price__details">
                                <span>
                                    <i className='fa-solid fa-car-side'> &nsbp; Jaguar</i>
                                </span>
                                <span style={{ textAlign:'right' }}>
                                    4/5 &nsbp; <i className='fa-solid fa-car-side'></i>
                                </span>
                                <span>

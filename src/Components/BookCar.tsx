              ...
              <form className="box-form">
                <div className="box-form__car-type">
                  ...
                  <select value={carType} onChange={handleCar}>
                    ...
                    <option value="VolksWagen Polo GT">
                      VolksWagen Polo GT
                    </option>
                    <option value="BMW-5">BMW-5</option>
                    <option value="Jaguar XF">Jaguar XF</option>
                    <option value="Toyota Fortuner SW4">
                      Toyota Fortuner SW4
                    </option>
                    <option value="Mahindra Thar SUV LX">
                      Mahindra Thar SUV LX
                    </option>
      ...
      <div className={`booking-modal ${modal ? "active-modal" : ""}`}>
        ...
        <div className="booking-modal__message">
          <h4>
            ...
            Upon completing this reservation enquiry, you will receive a
            confirmation email with the details of your booking and further
            instructions.
          </h4>
          <p>
            Upon completing your reservation, receive a rental voucher and
            toll-free support number for assistance on arrival.
          </p>
        </div>
        ...
        <div className="booking-modal__car-info">
          ...
          <div className="booking-modal__car-info__model">
            <h5>
              <span>Car Model You Slelected -</span>
              {carType}
            </h5>
